...
public class ShoesInnerController implements Initializable {
    @FXML
    ...
    ArrayList<ProductInnerController> arr3;
    int sid;
    void setId(int Id)
    {
        this.sid = Id;
    ...
    void setinnerid()
    {
        for(ProductInnerController p : arr3)
        {
            p.setId(sid);
        }
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        arr3 = new ArrayList<ProductInnerController>();
        String pro_name;
        int pro_price;
        String pro_color;
        String pro_size;
        ...
        try {
            ...
            String query="Select P#, PNAME, PRICE, COLOR, PSIZE, T_ID, PIMAGE from PRODUCT where T_ID = 2";
