...
public class GlassesInnerController implements Initializable {
    @FXML
    ...
    ArrayList<ProductInnerController> arr2;
    int gid;
    void setId(int Id)
    {
        this.gid = Id;
    ...
    void setinnerid()
    {
        for(ProductInnerController p : arr2)
        {
            p.setId(gid);
        }
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        arr2 = new ArrayList<ProductInnerController>();
        String pro_name;
        int pro_price;
        String pro_color;
        String pro_size;
        ...
        //Blob pro_image;
        Tname.setText("Glasses");
        try {
            DriverManager.registerDriver((new OracleDriver()));
            String URL="jdbc:oracle:thin:@localhost:1521:XE";
            Connection con = DriverManager.getConnection(URL, "C##alaa", "alaa");
            con.setAutoCommit(false);
            String query="Select P#, PNAME, PRICE, COLOR, PSIZE, T_ID, PIMAGE from PRODUCT where T_ID = 3";
