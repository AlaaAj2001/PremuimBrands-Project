...
public class WatchesInnerController implements Initializable {
    @FXML
    ...
    ArrayList<ProductInnerController> arr4;
    int wid;
    void setId(int Id)
    {
        this.wid = Id;
    ...
    void setinnerid()
    {
        for(ProductInnerController p : arr4)
        {
            p.setId(wid);
        }
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        arr4 = new ArrayList<ProductInnerController>();
        String pro_name;
        int pro_price;
        String pro_color;
        String pro_size;
        ...
        //Blob pro_image;
        Tname.setText("Watches");
        try {
            DriverManager.registerDriver((new OracleDriver()));
            String URL="jdbc:oracle:thin:@localhost:1521:XE";
            Connection con = DriverManager.getConnection(URL, "C##alaa", "alaa");
            con.setAutoCommit(false);
            String query="Select P#, PNAME, PRICE, COLOR, PSIZE, T_ID, PIMAGE from PRODUCT where T_ID = 4";
